class Style:
    r"""
    A possible initial state of the Document.

    There are two possibilities: Bare and Plain. Plain is effectively
    plain.tex from the TeX distribution. Bare loads nothing beyond
    compatibility with TeX itself.
    ...
    Attributes:
        CATCODES: a dict mapping codepoints to category codes. This is kept
        ...
        MACROS: a dict mapping identifiers to descriptions of macros.
            The format is the same as produced by Macro.__getstate__(),
                ...
                which holds a triplet of three integers:
        ...
        LOCATION_FILENAMES: a list of strings giving filenames; see MACROS
            above.

        OTHER: a dict mapping strings to representations of objects,
